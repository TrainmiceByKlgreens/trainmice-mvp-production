...
export interface Course {
  ...
  courseNotes?: any[];
  adminCourseNotes?: AdminCourseNote[];
  created_at: string;
  updated_at: string;
}

export interface AdminCourseNote {
  id: string;
  courseId?: string;
  course_id?: string;
  adminId?: string;
...
export type CustomCourseRequestStatus = 'pending' | 'rejected' | 'in_progress' | 'tbc' | 'course_outline_pending' | 'course_outline_ready';
...
export interface CustomCourseRequest {
  ...
  budget: number | null;
  status: CustomCourseRequestStatus;
  ...
  number_of_training_days?: number | null;
  proposed_training_date?: string | null;
}
